...
export const EntityInformationSchema = z.object({
    ...
    phonenumber: z.string().min(8, { message: "Phone number should be minimum 8 characters" }),
...
export type EntityInformationValidation = z.infer<typeof EntityInformationSchema>;
