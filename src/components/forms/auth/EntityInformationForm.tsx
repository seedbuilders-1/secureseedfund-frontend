...
import { EntityInformationSchema, EntityInformationValidation } from "@/lib/validations/onboarding";
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full">
                ...
                <Button onClick={() => handleNext()} className="w-full rounded-md h-[40px] mt-3" >
                    Next
                </Button>
