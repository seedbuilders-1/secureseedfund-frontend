      ...
      <div className="w-full">
        ...
        <div className="flex flex-col justify-center  ml-5">
          <div>
            ...
            <div className=" border border-slate-300 py-8 px-8 rounded-2xl mt-4 flex justify-between items-center">
              <div>
                ...
                <p className="text-[14px] text-slate-600 mt-2">
                  ...
                  Tempora laudantium architecto impedit similique error, sequi
                  ad nemo at deserunt sed?
                </p>
              </div>
              <div>
                <Switch.Root
            ...
            <h2 className="text-slate-600 text-[15px] text-center mt-3">
              Do you accept the{" "}
              <span className="text-primaryMain">terms & conditions</span> and{" "}
              <span className="text-primaryMain">privacy policy</span>
            </h2>
          </div>
