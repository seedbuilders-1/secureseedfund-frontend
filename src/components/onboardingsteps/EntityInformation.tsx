                    ...
                    <RadioGroup.Root value={selectedValue} onValueChange={handleChange}>
                        <div className="flex gap-4">
                            <RadioGroup.Item value="individual">
                                <div
                                    className={`w-[260px] relative px-8 py-4 border-[2px] rounded-md cursor-pointer ${selectedValue === "individual"
                                        ? "border-primaryMain"
                                        : "border-slate-300"
                                        }`}
                                >
                                    <div className="absolute left-[21px] bottom-[28px]">
                                        {selectedValue === "individual" ? <CiCircleCheck className="text-primaryMain " style={{ fontWeight: 'bold' }} /> : <IoIosRadioButtonOff className="text-slate-300" />}
                                    </div>
                                    <div>
                            ...
                            <RadioGroup.Item value="institutional">
                                <div
                                    className={`w-[260px] relative px-8 py-4 border-[2px] rounded-md cursor-pointer ${selectedValue === "institutional"
                                        ? "border-primaryMain"
                                        : "border-slate-300"
                                        }`}
                                >
                                    <div className="absolute left-[21px] bottom-[28px]">
                                        {selectedValue === "institutional" ? <CiCircleCheck className="text-primaryMain " style={{ fontWeight: 'bold' }} /> : <IoIosRadioButtonOff className="text-slate-300" />}
                                    </div>
                                    <div>
                                        <h2 className="text-slate-700 text-[16px] ">
                ...
                <div>
                    {selectedValue === "institutional" &&
                        <div className="space-y-4 mt-4 flex gap-4">
                            ...
                            <Button size="sm" variant="outline" className="border-primaryMain text-primaryMain"> Upload Logo</Button>
                        </div>
                    }
                </div>
                <div className="mt-8">
