  ...
  return (
    <header className="w-[90%] h-[45vh]  mx-auto px-8 pt-4">
      <div className="flex w-full items-center justify-between mt-4">
        ...
        <h1 className="font-semibold text-[28px]">Good Morning,
          {
            user?.firstName
          }
        </h1>
        ...
        <Link href="/startup/dashboard">
          <div
            className={` flex  gap-1 items-center justify-between rounded-[30px] text-[#050505]   font-[500] px-3 py-2 text-[.875rem] cursor-pointer ${isActive("/startup/dashboard") && "border bg-[#F3FFDE] text-[#6C8C3C]"
              }`}
          >
          ...
          <div
            className={` flex  gap-1 items-center justify-between rounded-[30px]   font-[500] px-3 py-2 text-[.875rem] cursor-pointer text-[#050505] ${isActive("/startup/campaign") && "border bg-[#F3FFDE] text-[#6C8C3C]"
              }`}
          >
          ...
          <div
            className={` flex  gap-1 items-center justify-between rounded-[30px] text-[#050505]  font-[500] px-3 py-2 text-[.875rem] cursor-pointer ${isActive("/startup/profile") && "border bg-[#F3FFDE] text-[#6C8C3C]"
              }`}
          >
