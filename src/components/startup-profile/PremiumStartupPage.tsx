...
const PremiumStartupPage = ({ hasCampaign, startup, isLoading }: Props) => {
  ...
  const { data: institutionInformation } = useGetInstitutionQuery({
  ...
  return (
    <>
      {institutionInformation?.is_completed_info === false ? (
        <WarningComponent
          showLink={false}
          title={"Please fill in your account section to invest in a startup"}
          linkTitle={""}
        />
      ) : (
        ""
