...
const RecentFunding = ({ currentCampaign }: Props) => {
  ...
  const lastMilestone = currentCampaign?.milestones[currentCampaign?.milestones.length - 1]
  return (
    ...
    <div className="w-full border border-slate-300 rounded-[0.6rem] px-2 flex flex-col py-4 h-[669px]">
      ...
      <div className="w-full">
        ...
        <div className="px-3 mt-5 space-y-10">
          <h1 className="text-[28px]  font-medium">{currentCampaign?.title}</h1>
          <p className="text-[14px] max-w-[658px] mt-4 text-[#292D32]">{currentCampaign?.description}</p>
          <section className="flex justify-between mt-[1.5rem]">
            <div className="bg-[#F5FAED] px-4 py-4 flex items-center justify-between w-[218px] rounded-md">
              <div>
                ...
                <h2 className="font-bold text-[#6C8C3C] text-[18px]"> { currentCampaign && `N${thousandFormatter(currentCampaign?.fundingGoal)}`}</h2>
              </div>
            ...
            <div className="bg-[#F5FAED] px-4 py-4 flex items-center w-[218px] justify-between rounded-md">
              <div>
                ...
                <h2 className="font-bold text-[#6C8C3C] text-[18px]">{daysLeft}</h2>
              </div>
          ...
          <div className="my-6 space-y-4">
            ...
            <div className="w-full border border-slate-300 rounded-[0.6rem]  flex px-4 items-center gap-5 py-4">
              ...
              <div>
                <p className="text-[14px] max-w-[508px] mt-4 text-[#292D32]">{lastMilestone?.milestoneTitle}</p>
       ...
       <h2 className="font-bold text-[18px]">   You have no Current Campaign </h2>
     </div>}
    </div>
  );
};
