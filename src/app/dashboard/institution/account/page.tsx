...
const AccountPage = () => {
  ...
  const { data: institutionInformation, isLoading } = useGetInstitutionQuery({
  ...
  return (
    <>
      {institutionInformation?.is_completed_info ? (
        <AccountSettings accountInformation={institutionInformation} />
      ) : (
        <div className="w-[100%] md:w-[90%] flex flex-col h-[100vh] bg-white mt-[4rem] mx-auto">
          <div className="bg-[#0F8B3A] rounded-md md:rounded-2xl px-2 mx-auto gap-[5px] w-full py-[2rem] md:px-5 flex flex-row justify-between items-center md:space-y-3">
            <div className="flex flex-col md:block">
              ...
              <div
                onClick={() =>
                  router.push(`/dashboard/institution/account/accountform`)
                }
