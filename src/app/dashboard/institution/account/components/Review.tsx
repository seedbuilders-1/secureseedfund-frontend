      ...
      {!deploy ? (
        <div className="w-full  space-y-6 px-5">
          <h2 className="text-[#0F172A] text-[24px] font-medium text-center mt-8">
            Hi {user?.firstName}, carefully review your answers before
            submission
          </h2>
          <h3 className="text-[#747474] text-[16px] mt-3 text-center">
            Make sure to carefully go over the answers provided and make
            necessary changes before submissionon
          </h3>
