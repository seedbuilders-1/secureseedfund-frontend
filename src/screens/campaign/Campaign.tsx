  ...
  return (
    <div className='w-[90%] flex flex-col  mx-auto h-[100vh] bg-white mt-[4rem]'>
      <div className='bg-[#241A3F] rounded-2xl  w-full py-[1rem] px-5 flex justify-between items-center space-y-3' >
        <div>
          <h2 className='text-white  text-[28px] font-semibold'>Launch Your Dream Project Today</h2>
          <div
      ...
      <div className='mt-[1.5rem] '>
        ...
        {loadingCampaign ?
          <Loader2
           className="flex items-center justify-center animate-spin mx-auto w-[300px]" 
           /> :
